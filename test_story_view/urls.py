...
urlpatterns = [
    ...
    path('add-new', views.add_test_story_view, name='add_test_story_view'),
    ...
    path('edit-story/<int:id>', views.edit_test_story_view, name='edit_test_story_view'),
    path('edit-story/<int:id>/', views.edit_test_story_view, name='edit_test_story_view'),

    path('remove-bdd-tdd-story/<int:id>', views.delete_test_story_view, name='delete_test_story_view'),
    path('remove-bdd-tdd-story/<int:id>/', views.delete_test_story_view, name='delete_test_story_view'),
    ...
    path('create-copys/<str:ids>', views.select_test_story_view, name='select_test_story_view'),
    path('create-copys/<str:ids>/', views.select_test_story_view, name='select_test_story_view'),
